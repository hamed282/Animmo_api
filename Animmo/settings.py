...
SECRET_KEY = 'django-insecure-@^mt)pp$*muc8kzp#02w@ww+5fxji8pqdi&6makp4@2+%t#$)e'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':  {
                            'simple_tags': 'accounts.templatetags.i18n_switcher',
                        }
        },
    },
]

WSGI_APPLICATION = 'Animmo.wsgi.application'
...
API_ENDPOINT = "https://panel.spotplayer.ir/license/edit/"
# your API key here
API_KEY = "ZLYibHK9isbVtjpamIu3uVujjQM3"
