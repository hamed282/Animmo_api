...
class CourseModel(models.Model):
    category = models.ForeignKey(SubCategoryModel, on_delete=models.CASCADE, related_name='category_course')
    subcategory = models.ForeignKey(SubCategoryModel, on_delete=models.CASCADE, related_name='subcategory_course')
...
class SampleExercise(models.Model):
